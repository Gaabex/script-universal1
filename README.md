...
-- Função que aplica Noclip em todas as partes do personagem
...
-- Mantém Noclip ativo continuamente
...
-- Detecta respawn e reaplica Noclip
...
print("✅ Noclip carregado. Pressione N para ativar/desativar.")
